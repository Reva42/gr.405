...
namespace SLIDESHOW_MED_KNAPPER_SOM_VIRKER
{
    public partial class Form1 : Form
    {
        ...
        private void prevKnap_Click_1(object sender, EventArgs e)
        {
            currentIndex--;
        }

        private void halvcirkelknap1_Click(object sender, EventArgs e)
        {

        }

        private void halvcirkelknap1_Click_1(object sender, EventArgs e)
        {
